...
echo "  1. 🚫 Banned phrase hides comment (e.g. contains 'idiot' or 'fake news')"
...
echo "  6. 🚨 Manual reports from three unique subscribers auto-hide the comment"
echo ""
...
echo ""
echo "🔭 Coming Up:"
echo "  Phase 5C - Moderator dashboard & review queue"
echo ""
